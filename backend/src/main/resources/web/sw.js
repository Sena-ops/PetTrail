const CACHE_NAME = 'pattrail-map-v3';
const STATIC_CACHE = 'pattrail-static-v3';

// Files to cache (app shell only - NO OpenStreetMap tiles)
const STATIC_FILES = [
    '/web/',
    '/web/index.html',
    '/web/styles.css',
...
self.addEventListener('fetch', event => {
    ...
    // NEVER cache OpenStreetMap tile requests
    if (url.hostname.includes('tile.openstreetmap.org')) {
        console.log('OpenStreetMap tile request - not caching:', url.href);
        return; // Let the request go to network, don't cache
    }
